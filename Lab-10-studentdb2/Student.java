...
public class Student implements Serializable{
    ...
    public Student(String studentNumber, String firstName, char middleInitial, String lastName, String course,
                   int yearLevel, String crushName, String courseCode, String courseDescription) {
        super();
    ...
    public String toString() {
        return String.format("Student Number: %s\nFirst Name: %s\nMiddle Initial: %c\nLast Name: %s\nDegree Program: %s\nYear Level: %d\nCrush's Name: %s\nFavorite Subject: %s, %s", studentNumber, firstName, middleInitial, lastName, course, yearLevel, crushName, getCourseCode(), getCourseDescription());
    }
